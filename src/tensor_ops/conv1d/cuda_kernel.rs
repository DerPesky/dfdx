...
fn make_3d<S: Shape>(strides: S::Concrete) -> [usize; 2] {
    match S::NUM_DIMS {
    ...
    CudaBlas: Gemm<E>,
{
    ...
    fn forward<L: Shape, R: Shape, O: Shape>(
        ...
        let patches_item_numel = op.groups * op.chan_in * op.kernel * op.len_out;
        ...
        unsafe {
            ...
            let cfg = launch_cfg::<128>((op.batch * op.groups * op.chan_in * op.len_out) as u32);
    ...
    fn backward<L: Shape, R: Shape, O: Shape>(
        ...
        let patches_item_numel = op.chan_out * op.kernel * op.len_in;
        let patches_numel = op.batch * patches_item_numel;
        let filters_numel = op.chan_in * op.chan_out * op.kernel;
        ...
        unsafe {
            ...
            let cfg = launch_cfg::<128>((op.batch * op.chan_out * op.len_in) as u32);
